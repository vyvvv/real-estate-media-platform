      ...
      <div className="items-center flex justify-between gap-4 h-10">
        ...
        <div className="flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full rounded-full border border-gray-200 bg-gray-100 px-4 py-3 text-sm text-gray-900 shadow-sm outline-none placeholder:text-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
          />
        </div>
